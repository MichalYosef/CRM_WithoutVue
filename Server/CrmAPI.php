...
//      and also for $_GET requests
        ...
        if(isset($_POST['userInput'])/* && function_exists($_POST['action'])*/) 
        {
            $dataFromClient = json_decode( $_POST['userInput'] );

        /* Request data from client structure:
            data: {
                        action: requiredAction, 
                        data: JSON.stringify( newObj.getDataObj())
                    }
        */
